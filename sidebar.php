...
<div class="sidebar">
    ...
    <a href="add_vendors_products.php">Vendors & Products</a>
    <a href="purchase_order.php">Create Purchase Order</a>
    <a href="view_purchase_orders.php">Pending orders</a>
    <a href="view_inventory_stock.php">Purchases</a>
